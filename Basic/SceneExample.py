...
class MyScene(pyghelpers.Scene):  # Inherits from the Scene class in the pyghelpers file
    ...
    def handleInputs(self, events, keyPressedList):
        ...
        This method MUST be included in every scene to override the one here
        """
        for event in events:
    ...
    def leave(self):
        ...
        If you want to do anything when you leave the current scene, you can write
        your own leave() method and add whatever code you want to run at that time.
        """
        pass
